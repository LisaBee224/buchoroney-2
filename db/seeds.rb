...
Guest.create(first_name: "David", last_name: "Moroney", email: "dave@dave.com", party_id:3, meal_id:1)
Guest.create(first_name: "Kylie", last_name:"Minogue", email: "keylie@key.com", party_id:3, meal_id:1)

Meal.create(desc: "ice cream")
Meal.create(desc: "fish pie")
Meal.create(desc: "bubblegum")
Meal.create(desc: "kids")
Meal.create(desc: "NA")